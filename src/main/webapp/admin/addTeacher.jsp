    ...
    <div class="wrapper wrapper-content">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <div class="row">
                    <label class="col-sm-1 control-label text-right">教师编号</label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control input-sm" id="tno" name="tno" placeholder="教师编号"/>
                    </div>
                    <label class="col-sm-1 control-label text-right">姓名</label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control input-sm" id="tname" name="tname" placeholder="姓名"/>
                    </div>
        ...
        <div class="modal-dialog" style="width:400px">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="addStudentlable">教师信息录入</h4>
                </div>
                        ...
                        <form method="post" class="form-horizontal" id="addform">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 controls">
                                    <input type="text" value="" class="form-control" name="tno"
                                           id="tno_add"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 controls">
                                    <input type="text" value="" class="form-control" name="tname" id="tname_add">
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <div class="modal-dialog" style="width:400px">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="updateStudentLabel">教师信息修改</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <form method="post" class="form-horizontal" id="updateform">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 controls">
                                    <input type="text" value="" class="form-control" name="tno"
                                           id="tno_up" readonly="true"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">姓名</label>
                                <div class="col-sm-8 controls">
                                    <input type="text" value="" class="form-control" name="tname"
                                           id="tname_up"/>
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    $(function () {
        ...
        vform('addform',addTeacher);
        vform('updateform',updateTeacher);

        var $table=$('#table');
        $table.bootstrapTable({
            url:'/ysms/teacher/list',
            toolbar:'#toolbar',
    ...
    function deleteStudent() {
        ...
        swal({
            ...
            if (isconfirm){
                $.ajax({
                    url:'/ysms/teacher/deleteTeacher',
                    type:'post',
                    async: 'true',
                    cache:false,
