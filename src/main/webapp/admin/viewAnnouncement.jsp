    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title" style="display:none;">
            <div class="row">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control input-sm" id="title" name="title" placeholder="考勤编号"/>
                </div>
                <label class="col-sm-1 control-label text-right">正文</label>
                <div class="col-sm-2">
                    <input type="text" class="form-control input-sm" id="text" name="text" placeholder="考勤课程"/>
                </div>
            </div>
